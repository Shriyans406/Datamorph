        ...
        <div className="p-8 max-w-5xl mx-auto space-y-8">
            <header>
                ...
                <p className="text-slate-400 mt-2">
                    Verify Phase 14: Error boundaries, structured logging, and monitoring capture.
                </p>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <section className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                    ...
                    <button
                        ...
                        disabled={crashUI}
                        className="w-full py-2 bg-red-900/30 hover:bg-red-900/50 text-red-400 border border-red-900/50 rounded-lg transition-colors disabled:opacity-50"
                    >
                        Trigger UI Crash
                    </button>
                    {crashUI && (
                        <button
                            ...
                            className="w-full mt-2 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-lg transition-colors"
                        >
                            Reset Component
                        </button>
                    )}
                ...
                <section className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                    ...
                    <p className="text-slate-400 text-sm mb-4">
                        Test structured logging and unhandled server-side API exceptions (for Sentry).
                    </p>

                    <div className="flex gap-4 mb-4">
                        <button
                            onClick={triggerApiCrash}
                            className="flex-1 py-2 bg-orange-900/30 hover:bg-orange-900/50 text-orange-400 border border-orange-900/50 rounded-lg transition-colors"
                        >
                            Test API Crash (500)
                        </button>
                        <button
                            onClick={testLogger}
                            className="flex-1 py-2 bg-indigo-900/30 hover:bg-indigo-900/50 text-indigo-400 border border-indigo-900/50 rounded-lg transition-colors"
                        >
                            Emit Structured Log
                        </button>
                    </div>
